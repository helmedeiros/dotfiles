...
export JAVA_HOME_15=$(/usr/libexec/java_home -v '15.0.2')
...
alias java15='export JAVA_HOME=$JAVA_HOME_15; launchctl setenv JAVA_HOME $JAVA_HOME_15; export PATH="$JAVA_HOME/bin:$PATH"; java -version'
